...
public class ShowCode
{
	...
	public ShowCode() { listings = new TreeMap<String,ShowLines>(); }
	
	
	public void add(String fnm)// add fnm-ShowLines pair to map
	{
	...
	public String show(String fnm, int lineNum)// return the specified line from fnm
	{
